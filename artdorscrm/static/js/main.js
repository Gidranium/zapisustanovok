            ...
            <div class="modal">
                ...
                <div class="modal-body">
                    <form id="booking-form">
                        ...
                        <div class="form-group" id="route-group" style="margin-top: 8px;">
    <button type="button" class="btn btn-outline" id="build-route-btn">Построить маршрут</button>
</div>
